...
In 1973, F.J. Anscombe published a short paper titled "Graphs in Statistical Analysis" (see References below for details). At the time, the use of computers for statistical calculations was becoming more common. Anscombe's thesis is summarized thus:
...
To demonstrate his point, he created a quartet of X-Y pairs.

In this example, we will use R to work through Anscombe's paper.

First, we load the necessary packages for data manipulation and graphics.
