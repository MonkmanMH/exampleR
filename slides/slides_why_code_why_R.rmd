...
<img src="../img/library stats act_1894.jpg" alt="Legislative Library & Bureau of Statistics Act, 1894" width = "600">
...
![the data science process](../img/data-science-collection.png)

source: Grolemund & Wickham, _R for Data Science_
...
* RStudio is also active creating and supporting packages
...
What are the odds of winning the 6/49 lottery?

$\binom{n}{r}$ : picking _r_ items from a set of size _n_ 
...
math notation: https://www.calvin.edu/~rpruim/courses/s341/S17/from-class/MathinRmd.html 
...
<img src="../img/rose_curve-4-5.png" alt="rose curve" width = "400">
...
<img src="../img/Seattle_diversity_gradient.jpg" alt="Seattle diversity gradient" width = "800">
...
![retail trade, B.C.](../img/retail_trade_BC_2019-09.png)
...
![](../img/plot_age_groupdist_BC_2019.png)

---

B.C. population: compare 1971 to 2019


![](../img/plot_smooth_years.png)
